...
class PageSection(models.Model):
    ...
    overview_text = models.CharField(max_length = 255, blank = True, null = True)
...
class SectionContent(models.Model):
    ...
    image = models.ImageField(upload_to = 'section_content/', blank = True, null = True)

    person_name = models.CharField(max_length = 100, blank = True, null = True)
    person_role = models.CharField(max_length = 100, blank = True, null = True)
    ...
    def __str__(self):
        return self.title or self.person_name or f"Content Item #{self.id}"
